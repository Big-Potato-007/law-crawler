...
from .models import ParsedDocument, SearchConfig
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="抓取法律法规/国家标准并输出 Markdown")
...
def main() -> None:
    ...
    if not urls:
        print("未获取到可抓取的 URL，请检查关键词或输入参数。")
        return
    ...
    for item in crawled:
        ...
        category = extractor.classify_content(item.title, markdown_body)
